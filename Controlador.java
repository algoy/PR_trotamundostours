...
public class Controlador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        con.conectar();
        String sql = "INSERT VALUES FROM usuario (nombre, correo, rol, telefono) "
                + "VALUES(?, ?, ?, ?)";
        ...
        try(PreparedStatement pst = con.getConexion().prepareStatement(sql) ){
            pst.setString(1, request.getParameter("correos"));
            pst.setString(2, request.getParameter("nombres"));
            pst.setString(2, request.getParameter("roles"));
